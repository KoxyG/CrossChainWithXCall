...
const BridgeBsc = require('../artifacts/contracts/BridgeEth.sol/BridgeEth.json');

const { ethers } = require("hardhat");
const { abi } = require("../artifacts/contracts/xCallETH..sol/xCallETH.json");
...
async function main() {
  ...
  if (network.name === "sepolia") {
    const xCallETH = await ethers.getContractAt("xCallETH");
